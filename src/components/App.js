...
function App() {
	...
	const states = data;
	const cities = states[selectedStateIndex].cities;
	...
	return (
		<div id="main">
			...
			<label>State: </label>
			<select id="state" value={selectedStateIndex} onChange={(e) => {
			...
			<div id="state-name">{states[selectedStateIndex].name}</div>
			<div id="state-description">{states[selectedStateIndex].description}</div>

			<br />

			<label>City: </label>
			<select id="city" value={selectedCityIndex} onChange={(e) => {
			...
			<div id="city-name">{cities[selectedCityIndex].name}</div>
			<div id="city-description">{cities[selectedCityIndex].description}</div>

			<br />

			<label>Landmark: </label>
			<select id="landmark" value={selectedLandmarkIndex} onChange={(e) => {
			...
			<div id="landmark-name">{landmarks[selectedLandmarkIndex].name}</div>
			<div id="landmark-description">{landmarks[selectedLandmarkIndex].description}</div>
		</div>
	);
}
